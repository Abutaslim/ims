...
$mpdf->Cell(20,5,'',0,0, '');
	...
	$mpdf->WriteHTML('<div style="background-color: white;text-align:justify; text-justify: inter-word; margin_left:5px; width: 100%; height:100%; padding-right: 5%; font-size: 10px;"><ol >	
 		<li >This id card is transferable and is to be used by the holder for the period of his/her services with the hospital</li>
 		<li>It should be carried at all times and presented on demand</li>
 		<li>It must be returned to the Director Security when the officer ceases to be in the Services The hospital</li>
 </ol></div>');
...
//$mpdf->Output('$_SESSION["program"]', \Mpdf\Output\Destination::FILE);
$mpdf->Output();
