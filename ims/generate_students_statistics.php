...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM tblstudent WHERE  course_of_study = '$course_of_study' and `program_type` = '$entry_mode'  and session = '$session' ";
    ...
    if ($rows != 0) {
      ...
      echo "<meta http-equiv='refresh' content = '0; url = students_statistics.php'/>";
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Form to generate Students Statistics List</h1>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="generate_students_statistics.php" name="id_car_check">
                            <div class="card-body">
                        ...
                        <input type="text" class="form-control" id="course_of_study" placeholder="Enter Program"
                                    ...
                                    <div class="form-group" >
                        <label for="passenger">Entry Mode:</label>
                       
                        <input type="text" class="form-control" id="entry_mode" placeholder="Enter Entry Mode"
                                                name='entry_mode'>
